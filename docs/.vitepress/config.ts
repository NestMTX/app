...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Report a Bug', link: 'https://github.com/NestMTX/app/issues/new?assignees=&labels=&projects=&template=bug.md&title=' },
          { text: 'Request a Feature', link: 'https://github.com/NestMTX/app/issues/new?assignees=&labels=&projects=&template=feature.md&title=' },
          { text: 'Ask the Community', link: 'https://github.com/NestMTX/app/discussions?category=questions' },
          { text: 'Chat with the Community', link: 'https://discord.gg/hMAEuNa4Fd' },
        ],
        collapsed: true
      },
    ...
    socialLinks: [
      ...
      { icon: 'github', link: 'https://github.com/NestMTX/app' },
      { icon: {
