...
NestMTX is configured by default to use an SQLite database which is generated and stored in `/home/node/app/tmp/db.sqlite3`, however you are able to use your own custom database serves including:
